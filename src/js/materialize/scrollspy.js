...
export const ScrollSpy = function($, anim, Component) {
  'use strict';
  ...
  class ScrollSpy extends Component {
    ...
    _setupEventHandlers() {
      ...
      if (ScrollSpy._count === 1) {
        window.addEventListener('scroll', this._handleWindowScrollBound,{ passive: true });
    ...
    _removeEventHandlers() {
      if (ScrollSpy._count === 0) {
        window.removeEventListener('scroll', this._handleWindowScrollBound, {passive: true});
